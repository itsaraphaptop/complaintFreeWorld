...
class HistoryComplaintWidget extends StatefulWidget {
  const HistoryComplaintWidget({
    Key key,
    this.chkComp,
  }) : super(key: key);
  ...
  @override
  _HistoryComplaintWidgetState createState() => _HistoryComplaintWidgetState();
}

class _HistoryComplaintWidgetState extends State<HistoryComplaintWidget> {
